			...
			if ($loop->have_posts()) {
				...
				while ( $loop->have_posts() ) : $loop->the_post();
					...
					if (isset($_GET['skip']) || false === array_search($loop->post->ID, $cache_data)) {
						...
						$request = new SwiftAPI_Request_PastOrder($domain, $user, $order->billing_email, $order->billing_first_name, $order->billing_last_name, $_product, $order_id, null, null, $order->order_date);
